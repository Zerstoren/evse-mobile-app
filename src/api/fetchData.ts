...
export const setMainData = (data: any) => {
  store.dispatch(
    setStatusData({
      ...
      voltMeas2: parseFloat(data.voltMeas2.toFixed(1)),
      voltMeas3: parseFloat(data.voltMeas3.toFixed(1)),
      curMeas1: parseFloat(data.curMeas1.toFixed(1)),
      curMeas2: parseFloat(data.curMeas2.toFixed(1)),
      curMeas3: parseFloat(data.curMeas3.toFixed(1)),
